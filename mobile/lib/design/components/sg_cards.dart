...
/// Identity header for Account — avatar/initials, name, phone, masked National
/// ID, citizen reference. Read-only (brief §15).
class SgProfileCard extends StatelessWidget {
  const SgProfileCard({
    super.key,
    required this.name,
  ...
  /// Ordered (label, value) pairs rendered in a 2-column grid.
