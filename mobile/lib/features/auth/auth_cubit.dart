...
class CitizenProfile {
  ...
  factory CitizenProfile.fromJson(Map<String, dynamic> json) {
    ...
    final nationalIdMasked = json['national_id_masked'] as String?;
    ...
    if (citizenRef == null ||
      ...
      throw const FormatException(
        ...
        'citizen_reference, display_name, phone, national_id_masked, identity_status',
      );
    }
    ...
    return CitizenProfile(
      ...
      phone: phone,
      maskedNationalId: nationalIdMasked,
      status: identityStatus,
      dataReality: json['data_reality'] as String?,
    );
  }
  ...
  Map<String, dynamic> toJson() => {
    ...
    'phone': phone,
    'national_id_masked': maskedNationalId,
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        if (token == null || token.trim().isEmpty) {
          emit(const AuthFailure('Contract mismatch: Missing access_token in /api/v1/mobile/auth/login response.'));
          return;
        }
